...
def draw_score(score):
    ...
    screen.blit(score_text, (10, 10))  # Exibe no canto superior esquerdo
    ...
    while running:
        ...
        for rock in rocks:
            if rock.y >= SCREEN_HEIGHT:
                score += 1  # Incrementa a pontuação quando a rocha passa da tela
        ...
        # Desenhar o carro, as rochas e a pontuação
